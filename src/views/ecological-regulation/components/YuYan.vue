...
import { waterDobLine, trafficLine } from "@/view-charts/OpenRehearsal";
...
const option1 = waterDobLine(waterDataObj);
const trafficDataObj = reactive({
  waterData: [
    2, 7, 8, 9, 10, 12, 13, 15, 14, 15, 2, 3, 15, 3, 5, 2, 8, 5, 2, 9, 12, 10,
    5, 7, 9,
  ],
...
const option2 = trafficLine(trafficDataObj);
