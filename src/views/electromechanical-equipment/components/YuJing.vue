...
<template>
  <kt-left style="grid-template-rows: 333fr 333fr 333fr">
    <kt-item type="13" title="实时预警" :px="0">
      <div class="w-full h-full px-0 pt-0">
        <div
          class="w-full h-45 mt-[10px] bg-[#001D38]/[47%] grid grid-cols-[1.35fr_1fr_1fr_1fr_1fr_1fr] items-center text-[#EAF6FF] text-[12px] SourceHanSansCNRegular"
        >
          <div class="flex justify-center">预警项目</div>
          <div class="flex justify-center">当前值</div>
          <div class="flex justify-center">阈值</div>
          <div class="flex justify-center">超标幅度</div>
          <div class="flex justify-center">持续时间</div>
          <div class="flex justify-center">预警状态</div>
        </div>
        <Swiper
          class="deform-swiper !h-[calc(100%-60px)] !pt-[10px]"
        ...
        >
          <SwiperSlide v-for="(row, idx) in deformFirstRows" :key="idx">
            <div
              class="w-full h-46 grid grid-cols-[1.35fr_1.1fr_1fr_1fr_0.8fr_0.8fr] items-center text-[#fff] text-[12px] SourceHanSansCNRegular bg-[url('@/assets/img/yujing_thItem_bg.webp')] kt-bg-full"
            >
              <div class="flex justify-center">{{ row.name }}</div>
              <div class="flex justify-center">{{ row.curValue }}</div>
              <div class="flex justify-center">{{ row.maxValue }}</div>
              <div class="flex justify-center">{{ row.overValue }}</div>
              <div class="flex justify-center">{{ row.timer }}</div>
              <div
    ...
    <kt-item type="13" title="趋势预警" :px="0">
      <div class="w-full h-full px-0 pt-10">
        <div
          class="w-full h-45 mt-[10px] bg-[#001D38]/[47%] grid grid-cols-[1.22fr_1fr_1.07fr_1.2fr_1.3fr] items-center text-[#EAF6FF] text-[12px] SourceHanSansCNRegular"
        >
          <div class="flex justify-center">预警项目</div>
          <div class="flex justify-center">当前值</div>
          <div class="flex justify-center">趋势</div>
          <div class="flex justify-center">预计超限时间</div>
          <div class="flex justify-center">预警状态</div>
        </div>
        <Swiper
          class="deform-swiper !h-[calc(100%-60px)] !pt-[10px]"
        ...
        >
          <SwiperSlide v-for="(row, idx) in deformSecondRows" :key="idx">
            <div
              class="w-full h-46 grid grid-cols-[1.22fr_1fr_1.07fr_1fr_1.3fr] items-center text-[#fff] text-[12px] SourceHanSansCNRegular bg-[url('@/assets/img/yujing_foItem_bg.webp')] kt-bg-full"
            >
              <div class="flex justify-center">{{ row.name }}</div>
              <div class="flex justify-center">{{ row.curValue }}</div>
              <div class="flex justify-center">{{ row.overValue }}</div>
              <div class="flex justify-center">{{ row.timer }}</div>
              <div
                class="flex justify-center font-[600] text-[11px]"
                :class="row.color"
              >
                {{ row.state }}
              </div>
    ...
    <kt-item type="13" title="健康曲线" :px="0">
      <div class="w-full h-full px-0 pt-10">
        <div
          class="w-full h-45 mt-[10px] bg-[#001D38]/[47%] grid grid-cols-[1.22fr_1fr_1.07fr_1.2fr_1.3fr] items-center text-[#EAF6FF] text-[12px] SourceHanSansCNRegular"
        >
          <div class="flex justify-center">设备部件</div>
          <div class="flex justify-center">健康评分</div>
          <div class="flex justify-center">评分变化</div>
          <div class="flex justify-center">剩余寿命</div>
          <div class="flex justify-center">建议维护时间</div>
        </div>
        <Swiper
          class="deform-swiper !h-[calc(100%-60px)] !pt-[10px]"
          :modules="swiperModules"
        ...
        >
          <SwiperSlide v-for="(row, idx) in deformThirdRows" :key="idx">
            ...
            >
              ...
              <div class="flex justify-center">{{ row.timer }}</div>
              <div
                class="flex justify-center font-[600] text-[12px]"
                :class="row.color"
              >
                {{ row.state }}
              </div>
